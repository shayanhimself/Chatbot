...
| Build | **AGP 9**, **Gradle 9**, `gradle/libs.versions.toml` version catalog                                                                                                                                                                                                                                                                                                                   | AGP 9 stable line; catalogs standard. AGP 9 built-in Kotlin: omit `kotlin-android` plugin; set `compileOptions.targetCompatibility` once, and `jvmTarget` inherits it (never set separately)                                                                                                                                                                                                          |
